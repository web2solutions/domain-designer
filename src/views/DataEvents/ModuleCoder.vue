...
import { useDataEventsStore, useDomainsStore, useAlertStore, usePropertiesStore } from '@/stores';
...
const entity = ref({} as DataEventSchema);
...
onMounted(async () => {
  ...
  if (id) {
    ...
    properties.value = await propertyStore.getAllByDataEventId(id);
